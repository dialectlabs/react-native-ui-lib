...
declare class SkeletonView extends Component<SkeletonViewProps, SkeletonState> {
    ...
    fade(isFadeIn: boolean, onAnimationEnd?: Animated.EndCallback): any;
    showChildren: () => void;
    ...
    renderListItemLeftContent: () => any;
    renderStrip: (isMain: boolean, length: number, marginTop: number) => any;
    renderListItemContentStrips: () => any;
    getListItemStyle: any;
    renderListItemTemplate: () => any;
    renderTextContentTemplate: () => any;
    renderTemplate: () => any;
    renderAdvanced: () => any;
    renderWithFading: (skeleton: any) => any;
    renderSkeleton(): any;
    renderNothing: () => null;
    render(): any;
}
