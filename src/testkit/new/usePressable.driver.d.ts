...
export declare const usePressableDriver: <Props extends Partial<Pick<PressableProps, "onPress" | "onPressIn" | "onPressOut" | "onLongPress">>, DriverProps extends ComponentDriverResult<Props> = ComponentDriverResult<Props>>(driver: DriverProps) => PressableDriverResult<Props> & DriverProps;
