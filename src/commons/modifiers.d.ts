...
export declare function extractAccessibilityProps(props?: any): any;
export declare function extractAnimationProps(props?: any): any;
export declare function extractBorderRadiusValue(props: Dictionary<any>): number | undefined;
export declare function extractModifierProps(props: Dictionary<any>): any;
/**
 * TODO:
 * @deprecated switch to Modifiers#extractComponentProps
 */
export declare function extractOwnProps(props: Dictionary<any>, ignoreProps: string[]): any;
export declare function extractComponentProps(component: any, props: Dictionary<any>, ignoreProps?: string[]): any;
